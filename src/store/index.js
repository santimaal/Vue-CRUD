...
export default Vuex.createStore({
    state: {
        todolist : [
            { "id":shortid.generate(),"todo":"mesa1","desc":"프로야구 경기도 봐야합니다.","done":false},
            { "id":shortid.generate(),"todo":"mesa2","desc":"노는 것도 중요합니다.","done":true},
            { "id":shortid.generate(),"todo":"mesa3","desc":"Vue 학습을 해야 합니다","done":false},
            { "id":shortid.generate(),"todo":"mesa4","desc":"ES6공부를 해야 합니다","done":false}
        ]
    },
    mutations : {
